...
#ifndef TAO_CONFIG_INTERNAL_REFERENCE2_RULES_HPP
#define TAO_CONFIG_INTERNAL_REFERENCE2_RULES_HPP
...
namespace tao::config::internal::rules
{
   ...
   struct reference2_rest : pegtl::seq< reference2_list, pegtl::one< ')' > > {};  // For config_rules.hpp -- used without actions.
