...
namespace tao::config::internal
{
   ...
   inline void cbor_extension( Input& in, state& st )
   {
      ...
      throw pegtl::parse_error( format( __FUNCTION__, "require string to parse cbor", { st.temporary.type() } ), pos );
   }
   ...
   inline void copy_extension( Input& in, state& st )
   {
      ...
      if( &d == &s ) {
         throw pegtl::parse_error( format( __FUNCTION__, "copy to self detected", { &p } ), pos );
      }
   ...
   inline void jaxn_extension( Input& in, state& st )
   {
      ...
      throw pegtl::parse_error( format( __FUNCTION__, "require string to parse jaxn", { st.temporary.type() } ), pos );
   }
   ...
   inline void json_extension( Input& in, state& st )
   {
      ...
      throw pegtl::parse_error( format( __FUNCTION__, "require string to parse json", { st.temporary.type() } ), pos );
   }
   ...
   inline void msgpack_extension( Input& in, state& st )
   {
      ...
      throw pegtl::parse_error( format( __FUNCTION__, "require string to parse msgpack", { st.temporary.type() } ), pos );
   }
   ...
   inline void parse_extension( Input& in, state& st )
   {
      ...
      throw pegtl::parse_error( format( __FUNCTION__, "require string to parse value", { st.temporary.type() } ), pos );
   }
   ...
   inline void read_extension( Input& in, state& st )
   {
      ...
      throw pegtl::parse_error( format( __FUNCTION__, "require string as filename", { st.temporary.type() } ), pos );
   }
   ...
   inline void shell_extension( Input& in, state& st )
   {
      ...
      throw pegtl::parse_error( format( __FUNCTION__, "require string for shell command", { st.temporary.type() } ), pos );
   }
   ...
   inline void split_extension( Input& in, state& st )
   {
      ...
      throw pegtl::parse_error( format( __FUNCTION__, "require string to split", { st.temporary.type() } ), pos );
   }
   ...
   inline void ubjson_extension( Input& in, state& st )
   {
      ...
      throw pegtl::parse_error( format( __FUNCTION__, "require string to parse ubjson", { st.temporary.type() } ), pos );
   }
   ...
   inline void do_inner_extension( Input& in, state& st )
   {
      ...
      if( pegtl::parse< rules::inner, action, control >( in, st ) ) {
         ...
         throw pegtl::parse_error( format( __FUNCTION__, "unknown value extension", { { "name", ext } } ), pos );
      }
