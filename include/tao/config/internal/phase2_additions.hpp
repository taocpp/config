...
#ifndef TAO_CONFIG_INTERNAL_PHASE2_ADDITIONS_HH
#define TAO_CONFIG_INTERNAL_PHASE2_ADDITIONS_HH
...
namespace tao::config::internal
{
   ...
   inline void phase2_additions( json_t&& l, json_t& r )
   {
      try {
         phase2_value_add( std::move( l ), r );  // l is unchanged when a phase2_additions_error is thrown.
      }
      catch( const phase2_additions_error& /*unused*/ ) {
