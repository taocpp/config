...
#ifndef TAO_CONFIG_INTERNAL_PHASE2_REPACK_HPP
#define TAO_CONFIG_INTERNAL_PHASE2_REPACK_HPP
...
namespace tao::config::internal
{
   ...
   template< template< typename... > class Traits >
   [[nodiscard]] json::basic_value< Traits > phase2_repack( const json::basic_value< value_traits >& v )
   {
