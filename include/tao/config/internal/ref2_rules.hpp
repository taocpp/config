...
namespace tao::config::internal::rules
{
   ...
   struct ref2_part : pegtl::sor< ident, quoted, index, minus, ref2_must > {};
   struct ref2_list : pegtl::list_must< ref2_part, dot > {};
   struct ref2_rest : pegtl::seq< ref2_list, pegtl::one< ')' > > {};  // For grammar.hpp -- used without actions.
   struct ref2_must : pegtl::if_must< pegtl::one< '(' >, ref2_list, pegtl::one< ')' > > {};
   struct ref2_rule : pegtl::if_must< pegtl::one< '(' >, ref2_list, pegtl::one< ')' > > {};
